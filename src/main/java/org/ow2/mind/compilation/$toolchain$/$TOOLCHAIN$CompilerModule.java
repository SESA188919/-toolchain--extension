 ...
 * Contributors : yteissier@orange.com
 */
 ...
 */
public class CCSCompilerModule extends AbstractMindModule {

  protected void configureCompilerWrapper() {
    bind(CompilerWrapper.class).to($TOOLCHAIN$CompilerWrapper.class);
  }
}
